 ...
 */
final class Version20231128150732 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE program ADD category_id INT NOT NULL, ADD title VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE program DROP category_id, DROP title');
    }
}
